...
#define ObjCropToolbar_DEBUG_SHOWING_BUTTONS_CONTAINER_RECT 0   // convenience debug toggle

@interface ObjCropToolbar()
...
- (void)setup {
    ...
    [_doneTextButton setTitle: _doneTextButtonTitle ?
        _doneTextButtonTitle : NSLocalizedStringFromTableInBundle(@"Done",
                                                                  @"ObjCropViewControllerLocalizable",
                                                                  resourceBundle,
                                                                  nil)
    ...
    [_doneIconButton setImage:[ObjCropToolbar doneImage] forState:UIControlStateNormal];
    ...
    [_cancelIconButton setImage:[ObjCropToolbar cancelImage] forState:UIControlStateNormal];
    ...
    [_clampButton setImage:[ObjCropToolbar clampImage] forState:UIControlStateNormal];
    ...
    [_rotateCounterclockwiseButton setImage:[ObjCropToolbar rotateCCWImage] forState:UIControlStateNormal];
    ...
    [_rotateClockwiseButton setImage:[ObjCropToolbar rotateCWImage] forState:UIControlStateNormal];
    ...
    [_resetButton setImage:[ObjCropToolbar resetImage] forState:UIControlStateNormal];
...
#if ObjCropToolbar_DEBUG_SHOWING_BUTTONS_CONTAINER_RECT
