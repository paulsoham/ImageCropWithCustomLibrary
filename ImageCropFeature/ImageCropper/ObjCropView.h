...
@class ObjCropOverlayView;
@class ObjCropView;

NS_ASSUME_NONNULL_BEGIN

@protocol ObjCropViewDelegate<NSObject>

- (void)cropViewDidBecomeResettable:(nonnull ObjCropView *)cropView;
- (void)cropViewDidBecomeNonResettable:(nonnull ObjCropView *)cropView;

@end

@interface ObjCropView : UIView
 ...
 */
@property (nonatomic, assign, readonly) ObjCropViewCroppingStyle croppingStyle;
 ...
 */
@property (nonnull, nonatomic, strong, readonly) ObjCropOverlayView *gridOverlayView;
 ...
 */
@property (nullable, nonatomic, weak) id<ObjCropViewDelegate> delegate;
 ...
 */
- (nonnull instancetype)initWithCroppingStyle:(ObjCropViewCroppingStyle)style image:(nonnull UIImage *)image;
