...
#import "ObjCropToolbar.h"
#else
#import <ObjCropViewController/ObjCropViewConstants.h>
#import <ObjCropViewController/ObjCropView.h>
#import <ObjCropViewController/ObjCropToolbar.h>
#endif

@class ObjCropViewController;

///------------------------------------------------
/// @name Delegate
///------------------------------------------------

@protocol ObjCropViewControllerDelegate <NSObject>
@optional
 ...
 */
- (void)cropViewController:(nonnull ObjCropViewController *)cropViewController
...
@interface ObjCropViewController : UIViewController
 ...
 */
@property (nullable, nonatomic, weak) id<ObjCropViewControllerDelegate> delegate;
 ...
 */
@property (nonnull, nonatomic, strong, readonly) ObjCropView *cropView;
 ...
 */
@property (nonnull, nonatomic, strong, readonly) ObjCropToolbar *toolbar;

/**
 The cropping style of this particular crop view controller
 */
@property (nonatomic, readonly) ObjCropViewCroppingStyle croppingStyle;

/**
 A choice from one of the pre-defined aspect ratio presets
 */
@property (nonatomic, assign) ObjCropViewControllerAspectRatioPreset aspectRatioPreset;
 ...
 */
@property (nonatomic, assign) ObjCropViewControllerToolbarPosition toolbarPosition;
 ...
 */
- (nonnull instancetype)initWithCroppingStyle:(ObjCropViewCroppingStyle)style image:(nonnull UIImage *)image NS_SWIFT_NAME(init(croppingStyle:image:));
 ...
 */
- (void)setAspectRatioPreset:(ObjCropViewControllerAspectRatioPreset)aspectRatioPreset animated:(BOOL)animated NS_SWIFT_NAME(setAspectRatioPreset(_:animated:));
